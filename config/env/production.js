...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      adapter: "sails-mysql",
      url: "mysql://root:codextech@123@localhost:3306/webpeer"
      //--------------------------------------------------------------------------
  ...
  sockets: {
     ...
     ***************************************************************************/
    onlyAllowOrigins: [
      "https://webpeer.herokuapp.com",
      "https://webpeer.computers.pk"
    ]
    /***************************************************************************
     *                                                                          *
   ...
   ***************************************************************************/
  custom: {
    baseUrl: "https://apify.computers.pk",
    internalEmailAddress: "support@shopdesk.co",
    delay: 1000 * 60 * 5 // 5 mins
